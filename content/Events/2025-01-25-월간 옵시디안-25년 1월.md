...
description: Obsidian의 최신 플러그인 Web Clipper, Smart Composer, Templater with AI 활용법
  정리
summary: "2025년 1월 월간 Obsidian 업데이트에서 소개된 주요 플러그인들을 정리한 노트이다. Web Clipper를 활용한 웹 콘텐츠 저장 자동화, Smart Composer의 AI 기반 노트 작성 지원, Templater with AI로 템플릿에 AI 기능 통합하기, 그리고 이들을 결합한 효율적인 지식 관리 워크플로우 구축 방법을 포함한다."

---
title: Marker - 품질은 최고지만 안정성이 발목 잡는 PDF 파서
date: 2026-03-26
tags:
  - pdf-parser
  - document-ai
...
Marker는 파싱에 성공했을 때의 품질은 최고지만, 그 성공을 안정적으로 보장하지 못하는 파서다. 80.6%의 Edit Similarity는 테스트한 5개 파서 중 최고이며, 헤딩 레벨 구분, 이미지 참조, 위첨자 처리 등 Markdown 품질이 가장 풍부하다.

하지만 63% 실패율과 237초/문서의 처리 시간은 프로덕션 환경에서 감당하기 어려운 수준이다. **짧은 문서를 소량으로 처리하는 경우**에만 추천하며, 대량 처리나 안정성이 중요하다면 [[2026-03-26-Docling-PDF-파서-분석|Docling]](MIT, 100% 성공, 4.9초)이나 [[2026-03-23-MinerU-2x-파이프라인-분석|MinerU]](AGPL, 100% 성공, 69초)가 더 적합하다.

...
summary: "Inflearn의 UX/UI 시작하기 강의에서 UI 디자인 부분을 정리한 노트이다. UI 디자인의 기본 원칙(일관성, 계층구조, 피드백), 디자인 도구 사용법, 컬러/타이포그래피/레이아웃 설계, 반응형 디자인 구현, 그리고 실제 인터페이스 디자인 프로젝트 실습을 포함한다."

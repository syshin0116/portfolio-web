...
summary: "Modular RAG 챗봇이 사람처럼 기억할 수 있도록 Short Term Memory와 Long Term Memory를 구현한 설계 내용이다. 각 채팅방에서 최신 정보는 단기 기억으로, 중요한 정보는 장기 기억으로 저장하여 효율적인 메모리 관리와 자연스러운 대화 경험을 제공하는 방법을 다룬다."

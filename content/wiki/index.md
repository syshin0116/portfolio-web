...
| [[repo-intelligence-radar]] | Repo intelligence radar는 지식 위키 자체가 아니라 사용자에게 줄 수 있는 별도 외부 정보 소스/인텔리전스 피드다. Public-facing article [[2026-05-18-Tech-Intelligence-Radar]]와 연결되며, 레포뿐 아니라 논문·뉴스·블로그·소셜 신호까지 추적해 digest와 action queue로 제공하고, 필요한 항목만 knowledge base로 승격·업데이트한다. | pattern | github, open-source, changelog, research, automation, monitoring, pkm, workflow, ai, trend-tracking | 10 | 2026-05-18 |
...
| Source | Wiki pages |
|--------|------------|
| content/AI/2026-05-18-Tech-Intelligence-Radar.md | [[repo-intelligence-radar]] |

...
summary: "Naive RAG와 Advanced RAG를 넘어 Modular RAG 방식으로 진화한 설계 내용이다. LEGO 블록처럼 모듈을 조합하여 재사용 가능한 RAG 자산을 구축하는 것이 목표이며, 시스템의 유연성과 확장성을 크게 향상시켜 다양한 애플리케이션 요구사항에 맞게 모듈을 조합하고 최적화할 수 있는 아키텍처를 제시한다."

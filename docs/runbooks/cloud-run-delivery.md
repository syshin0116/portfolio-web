...
Production rollback also verifies the exact `openai:gpt-5.6-luna / 500000 / 53837`
...
reservation, or the 51,892 µUSD 512-output-token reservation is not an eligible rollback

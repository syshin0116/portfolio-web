...
summary: "원티드 프리온보딩 백엔드 과정의 Docker 교육 1일차 내용을 정리한 노트이다. Docker의 기본 개념과 아키텍처, 이미지와 컨테이너의 차이, Dockerfile 작성법, Docker Compose를 활용한 멀티 컨테이너 관리, 그리고 실제 백엔드 애플리케이션 컨테이너화 실습을 포함한다."

...
summary: "Men in Black 프로젝트에서 블랙박스 차량과 다양한 물체 간의 거리를 구하기 위해 MiDaS v3 Depth Estimation 모델을 연구한 논문 정리이다. Monocular Depth Estimation의 원리, MiDaS의 아키텍처, 그리고 실제 프로젝트 적용 방법을 다룬다."

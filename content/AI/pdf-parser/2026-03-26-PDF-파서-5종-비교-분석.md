...
## 파서별 파싱 결과 (원본 Markdown 출력)

동일한 PDF 첫 페이지를 각 파서가 어떻게 변환했는지 보여준다:

![MinerU 파싱 결과](https://i.imgur.com/pfiVfme.png)
...
![헤딩 추출 비교 — 5개 파서](https://i.imgur.com/X1FzPBY.png)
...
![테이블 추출 비교 — 5개 파서](https://i.imgur.com/Yth9cO5.png)
...
![수식 추출 비교 — 5개 파서](https://i.imgur.com/iMBugXO.png)
...
![이미지 추출 비교 — 5개 파서](https://i.imgur.com/8C2x4ea.png)

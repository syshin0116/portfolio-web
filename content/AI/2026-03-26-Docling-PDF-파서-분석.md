...
| 메트릭 | 값 |
|---|---|
| **Edit Similarity** | **74.3%** |
| **처리 시간** | 448초 (92문서, 7.5분) |
| **문서당 평균** | 4.9초 |
| **성공률** | 100% (92/92) |

### 파서 비교 (READoc 벤치마크)

| 파서 | Edit Similarity | 속도 (문서당) | 라이선스 | 가성비 |
|---|---|---|---|---|
| MinerU (MPS) | 77.2% | 69초 | AGPL-3.0 | 느림 |
| **Docling** | **74.3%** | **4.9초** | **MIT** | **최고** |
| PyMuPDF4LLM | 73.4% | 1.9초 | AGPL-3.0 | 빠름 |
| LiteParse | 50.7% | 0.1초 | MIT | 텍스트만 |
